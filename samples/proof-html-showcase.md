...
<deck-slide
  ...
  takeaway="The HTML deck can use renderer-owned SVG and animation while PPTX remains a practical editable handoff."
/>
...
<deck-journey-path
  metric="42%"
  metric-label="of avoidable delay sits in two handoffs. The presentation can show the journey, not just describe it."
...
<deck-impact-radar
  ...
  caption="The PPTX version embeds this renderer-owned SVG as a crisp visual."
></deck-impact-radar>
