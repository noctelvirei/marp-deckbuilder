...
- Brand backgrounds and logos are controlled by optional `assets` entries in `tool/resources/definitions/brand.json`. HTML embeds those background assets as self-contained data URLs; PPTX inserts them as slide images.
